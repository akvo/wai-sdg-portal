...
COPY public.option (id, name, question) FROM stdin;
\.
...
COPY public.question (id, name, form, meta, type, question_group) FROM stdin;
\.
...
COPY public.question_group (id, name, form) FROM stdin;
\.
