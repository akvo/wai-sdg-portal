...
class TestExcelValidation:
    ...
    async def test_validate_excel_file(self, session: Session) -> None:
        ...
        assert errors == [
            {
                ...
                "error_message": "Wrong sheet names or invalid file upload template",
                "sheets": "NOT DATA",
            }
        ]
        # Empty Sheet Error
        ...
        assert errors == [
            ...
            {
                "error": ExcelError.header,
                "error_message": "Test Datapoint Text Question doesn't have question id",
                "cell": "D1",
            },
            {
                "error": ExcelError.header,
            ...
            {
                "error": ExcelError.value,
                "error_message": "Invalid case: option a and Invalid value: Option D",
                "cell": "G3",
            },
            {
                "error": ExcelError.value,
