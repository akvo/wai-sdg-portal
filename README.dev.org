#+PROPERTY: header-args:sh      :results output raw verbatim
...
| root | 95594 | 94628 | 3 | 12:12 | ?   | 00:06:32 | /usr/local/bin/python | /usr/local/bin/uvicorn | main:app | --reload                         | --port | 5000         |                          |                |                        |
| root | 95595 | 95594 | 0 | 12:12 | ?   | 00:00:00 | /usr/local/bin/python | -c                     | from     | multiprocessing.resource_tracker | import | main;main(4) |                          |                |                        |
| root | 95596 | 95594 | 0 | 12:12 | ?   | 00:00:39 | /usr/local/bin/python | -c                     | from     | multiprocessing.spawn            | import | spawn_main;  | spawn_main(tracker_fd=5, | pipe_handle=7) | --multiprocessing-fork |
...
| root | 94849 | 94841 | 0 | 12:12 | ?   | 00:00:19 | /usr/local/bin/node | /app/node_modules/react-scripts/scripts/start.js |       |
...
| root | 95588 | 94704 | 3 | 12:12 | ?   | 00:06:34 | /usr/local/bin/python | /usr/local/bin/uvicorn | worker:worker | --reload                         | --port | 5001         |                          |                |                        |
| root | 95590 | 95588 | 0 | 12:12 | ?   | 00:00:00 | /usr/local/bin/python | -c                     | from          | multiprocessing.resource_tracker | import | main;main(4) |                          |                |                        |
| root | 95591 | 95588 | 0 | 12:12 | ?   | 00:00:44 | /usr/local/bin/python | -c                     | from          | multiprocessing.spawn            | import | spawn_main;  | spawn_main(tracker_fd=5, | pipe_handle=7) | --multiprocessing-fork |
